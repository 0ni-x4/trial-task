...
interface MobileEssayTabV2Props {
  essayContent: string;
  ...
  return (
    <div className="flex flex-col h-full w-full min-w-0 overflow-hidden">
      ...
      <div className="flex-1 min-h-0 min-w-0 w-full">
        <EssayEditorV2 value={essayContent} onChange={onContentChange} highlights={highlights} />
      </div>
    </div>
  );
};
